    ...
    <div className=" bg-background text-center">
      <section>
        ...
        <div
          className={`${
            chatbot ? "" : "hidden"
          } w-[300px] h-[300px] bg-orange-100 rounded-lg fixed bottom-24 p-3 left-24`}
        >
          <div className="">
            <ImCross
              className=""
          ...
          >
            <input
              ...
              className="w-full outline-none  bg-orange-100"
              value={question}
      ...
      <section style={{ backgroundImage: `url(${primaryImage})` }}>
        <div className="primary-container md:w-2/3 mx-auto gap-5 md:leading-10 leading-7 text-center  flex flex-col items-center justify-center h-[100vh] translate-y-14 relative ">
          {!sitestatus ? (
            ...
            <div className="bg-orange-500  p-3 w-45 flex flex-row items-center justify-center rounded-xl">
              <OutboundIcon
                style={{
                  color: "white",
                  marginLeft: "2px",
      ...
      <section className=" curved-right md:h-[80vh] bg-orange-200 my-[10vh] flex-row-between flex-wrap primary-container">
      ...
      <footer className="primary-container flex-col-center list-none text-white bg-cover bg-no-repeat bg-primary font-comf">
        ...
        <div className="">
          ...
          <p>© BrainIQ 2024 | All rights reserved</p>
        </div>
      </footer>
    </div>
  );
