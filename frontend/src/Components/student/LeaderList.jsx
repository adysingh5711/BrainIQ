...
const LeadersList = () => {
  const leaders = [
    ...
    { name: "Om ", marks: 1871, subject: "History", remarks: "Great" },
    { name: "Aman", marks: 1500, subject: "History", remarks: "Great" },
    { name: "Sonali", marks: 1230, subject: "History", remarks: "Great" },
    { name: "Aditya", marks: 1069, subject: "History", remarks: "Great" },
